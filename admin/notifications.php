...
<body>
  <div style="padding:1rem;display:flex;align-items:center;gap:1rem;"><a href="dashboard.php">← Back</a><h2>Notifications</h2><div style="margin-left:auto;"><button id="create-notif" class="submit-btn">Create</button></div></div>
